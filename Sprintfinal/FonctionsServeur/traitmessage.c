...
/*prend en parametre le message et le pseudo de celui qui envoie et on fait la mise en forme pour que les clients sachent d'ou vient le message */
...
/*traite le message pour voir quelle commande est associé et revoie le numéro du commande */
...
/*il faut que le nom ne contient pas d'espaces pour qu'il soit valide ! Cette fonction vérifie ça ! */
